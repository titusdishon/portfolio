export default function Summary() {
  return (
    <div className="container mb-32  p-3">
      <h5 className="text-3xl  w-1/2 my-6  bg-clip-text">Skills</h5>
      <p>
      ...
      <h5 className="text-3xl  w-1/2 my-6  bg-clip-text">Education</h5>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi maxime
        explicabo commodi, consectetur aperiam sed esse possimus porro
        consequatur ratione asperiores? Reprehenderit accusamus maxime dolor
      ...
      <h5 className="text-3xl  w-1/2 my-6 bg-clip-text">Certifications</h5>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi maxime
        explicabo commodi, consectetur aperiam sed esse possimus porro
        consequatur ratione asperiores? Reprehenderit accusamus maxime dolor
